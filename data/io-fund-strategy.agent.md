...
note: Agent-only decoder read by the chat assistant via read_doc('strategy'). NOT shown on the website — the human-facing page reads io-fund-strategy.md.
load_priority: high
audience: agent
...
Active, tech-only portfolio with technicals-driven portfolio management and in-house thematic research. Hedged via short correlated ETFs. Technicals-driven entries on top of product-first fundamental theses. All trades disclosed in real time via SMS + email.
...
Roughly 50% of new entries hit their stop for a small loss, then re-attempt on the next setup. Survivors become long-haul positions.
...
### Roles
- **Portfolio manager** — All trade alerts originate here. Technicals + WealthUmbrella quant signals.
- **Lead tech analyst** — Thematic deep dives, microtrend identification.
- **Equity analysts** — Fundamental + sector research.
...
- Beat top-performing funds 2020–2025 per the fund's published track record.
