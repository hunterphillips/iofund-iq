...
| Software | **PLTR** | Commercial surges (Q4 GAAP EPS +700%). Cash $7.18B, zero debt. **~50% trimmed 2026-05-18 @ $133.51** | "Software stocks will be tested" — IOF cautious on category; now half-sized |
...
- **RDDT** — **fully closed 2026-05-18 @ $158.85** (was Q2 held; "scarce asset" thesis intact but position exited)
- **PLTR** — **~50% trimmed 2026-05-18 @ $133.51** (half position remains; see picks table)
...
| **RDDT** | ✓ #1 software/data | ✓ contextual high-intent data | ✓ scarce asset → ✗ **closed 2026-05-18 @ $158.85** | Fully exited post-Q2; thesis not broken, position closed |
...
| **PLTR** | — | + Added (discipline vs conviction) | ✓ commercial surges → ↓ **~50% trimmed 2026-05-18 @ $133.51** | Half position remains; trim is risk management, not thesis break per IOF sizing patterns |
