...
```bash
.Codex/skills/pdf-extract/pdf-extract.sh <pdf-path> [pages]
```
...
```bash
# Whole document
.Codex/skills/pdf-extract/pdf-extract.sh "Discovery Workshops - notes.pdf"

# Pages 1–5 only
.Codex/skills/pdf-extract/pdf-extract.sh customer-discovery/docs/project-files/SOW.pdf 1-5

# Single page
.Codex/skills/pdf-extract/pdf-extract.sh notes.pdf 7
```
