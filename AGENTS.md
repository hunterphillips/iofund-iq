...
| `.Codex/skills/iofund-fetch/` | Python skill: authenticates against io-fund.com Firebase, fetches premium articles. |
...
- **Plans + handoffs** live in `thoughts/shared/plans/` and `pickup.md` per Codex conventions (the `create_plan`, `handoff`, and `pickup` skills use these paths).
